...
public class ListaLigada {
    ...
    /* No tenemos una función esLlena() porque en una lista ligada no hay un límite fijo de capacidad. */
    ...
    * Elimina el último nodo de la lista ligada.
    ...
    public void eliminaAlFinal() {
        ...
        actual.setSiguiente(null);          // El último nodo es actual.getSiguiente()
        tam--;
        System.out.println("Nodo eliminado al final.");
    }
